...
import { Product, getProductById, createProductAuction, ProductAuction, getProductAuctionById, addBidToProductAuction, getProductAuctionByProductId, deleteProduct } from '@/lib/api';
              ...
              {isOwner ? (
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  ...
                  <button
                    ...
                    disabled={isDeleting}
                    className="px-4 sm:px-6 py-3 border border-red-500 text-red-500 font-medium rounded-lg hover:bg-red-50 transition-all flex items-center justify-center touch-target text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isDeleting ? (
                      <>
